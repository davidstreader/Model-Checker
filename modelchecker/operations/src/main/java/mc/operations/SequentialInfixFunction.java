...
public class SequentialInfixFunction implements IProcessInfixFunction {
    ...
    public Automaton compose(String id, Automaton automaton1, Automaton automaton2) throws CompilationException {
        ...
        automaton2.getNodes().forEach(node -> {
            ...
            if (newNode.isStartNode()) {
                ...
                //for every stop node of automata1, get the edges that go into it, and replace it with the start node of automata2
     ...
     */
    private void copyAutomataEdges(Automaton writeAutomaton, Automaton readAutomaton, Map<String, AutomatonNode> nodeMap) {
