...
public class AndNode extends OperationNode {
  ...
  public String toString() {
    return "AndNode(firstOperation=" + this.getFirstOperation() + ", secondOperation=" + this.getSecondOperation() + ")";
  }

  public boolean equals(final Object o) {
    if (o == this) return true;
    if (!(o instanceof AndNode)) return false;
    final AndNode other = (AndNode) o;
  ...
  protected boolean canEqual(final Object other) {
    return other instanceof AndNode;
  }
