...
public class SetIndexTests extends ExpanderTests {
	...
	@Test
	public void correctSetIndexExpansionTest_1(){
	...
	@Test
	public void correctSetIndexExpansionTest_2(){
	...
	@Test
	public void correctSetIndexExpansionTest_3(){
		String input = "automata Test = ([{a}].b -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_4(){
	...
	@Test
	public void correctSetIndexExpansionTest_5(){
	...
	@Test
	public void correctSetIndexExpansionTest_6(){
	...
	@Test
	public void correctSetIndexExpansionTest_7(){
		String input = "automata Test = (a[{a}].b -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_8(){
	...
	@Test
	public void correctSetIndexExpansionTest_9(){
		String input = "automata Test = (a.[{a}] -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_10(){
		String input = "automata Test = (a.[{a}]b -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_11(){
		String input = "automata Test = (a.[{a}].b -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_12(){
		String input = "automata Test = (a.[{a}][3] -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_13(){
	...
	@Test
	public void correctSetIndexExpansionTest_14(){
	...
	@Test
	public void correctSetIndexExpansionTest_15(){
		String input = "automata Test = ([1][{a}].b -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_16(){
	...
	@Test
	public void correctSetIndexExpansionTest_17(){
		String input = "automata Test = ([{a, b}] -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_18(){
	...
	@Test
	public void correctSetIndexExpansionTest_19(){
		String input = "automata Test = ([{a, b}].b -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_20(){
	...
	@Test
	public void correctSetIndexExpansionTest_21(){
		String input = "automata Test = (a[{a, b}] -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_22(){
	...
	@Test
	public void correctSetIndexExpansionTest_23(){
		String input = "automata Test = (a[{a, b}].b -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_24(){
	...
	@Test
	public void correctSetIndexExpansionTest_25(){
		String input = "automata Test = (a.[{a, b}] -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_26(){
		String input = "automata Test = (a.[{a, b}]b -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_27(){
		String input = "automata Test = (a.[{a, b}].b -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_28(){
		String input = "automata Test = (a.[{a, b}][3] -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_29(){
		String input = "automata Test = ([1][{a, b}] -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_30(){
	...
	@Test
	public void correctSetIndexExpansionTest_31(){
		String input = "automata Test = ([1][{a, b}].b -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_32(){
	...
	@Test
	public void correctSetIndexExpansionTest_33(){
	...
	@Test
	public void correctSetIndexExpansionTest_34(){
	...
	@Test
	public void correctSetIndexExpansionTest_35(){
		String input = "automata Test = ([{a, b, c}].b -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_36(){
	...
	@Test
	public void correctSetIndexExpansionTest_37(){
	...
	@Test
	public void correctSetIndexExpansionTest_38(){
	...
	@Test
	public void correctSetIndexExpansionTest_39(){
		String input = "automata Test = (a[{a, b, c}].b -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_40(){
	...
	@Test
	public void correctSetIndexExpansionTest_41(){
		String input = "automata Test = (a.[{a, b, c}] -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_42(){
		String input = "automata Test = (a.[{a, b, c}]b -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_43(){
		String input = "automata Test = (a.[{a, b, c}].b -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_44(){
		String input = "automata Test = (a.[{a, b, c}][3] -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_45(){
	...
	@Test
	public void correctSetIndexExpansionTest_46(){
	...
	@Test
	public void correctSetIndexExpansionTest_47(){
		String input = "automata Test = ([1][{a, b, c}].b -> STOP).";
		ProcessNode node = constructProcessNode(input);
		Stack<ASTNode> branches = new Stack<ASTNode>();
		TerminalNode terminal = new TerminalNode("STOP", null);
	...
	@Test
	public void correctSetIndexExpansionTest_48(){
