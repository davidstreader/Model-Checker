...
public class Main {
    ...
    public ProcessBuilder createWrappedProcess() {
        ...
        ProcessBuilder builder = new ProcessBuilder("java","-Djansi.passthrough=true","-XX:+UseG1GC","-Dcom.sun.management.jmxremote.authenticate=false","-Dcom.sun.management.jmxremote=true","-Dcom.sun.management.jmxremote.port=1099","-Dcom.sun.management.jmxremote.ssl=false","-Djava.library.path="+nativePath,"-jar",Utils.getJarPath(),"reloaded");
