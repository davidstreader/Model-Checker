 ...
 *
 */
public class ProbabilsticChoiceFunction implements IProcessInfixFunction {
    ...
    public Automaton compose(String id, Automaton automaton1, Automaton automaton2)
        ...
        System.out.println("COMPOSE +p");  //Never get clled with STOP+P
        throw new CompilationException( this.getClass()," must not apply ProbabilsticChoiceFunction to Automata "+ id);
    }
    ...
    public Petrinet compose(String id, Petrinet net1, Petrinet net2, Set<String> flags) throws CompilationException {
        ...
        System.out.println("ProbabilsticChoiceFunction");
        net1.validatePNet();
