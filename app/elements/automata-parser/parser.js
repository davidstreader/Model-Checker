...
PEG.automataParser = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c20 = function(relabel) {
              return relabel;
             },
        peg$c21 = function(hide) {
              return hide;
             },
        ...
        peg$c48 = function(a, b) {
              return {"new-label":a.action, "old-label": b.action};
             },
        peg$c49 = /^[ -]/,
        peg$c50 = { type: "class", value: "[\\x20-\\x7F]", description: "[\\x20-\\x7F]" },
        peg$c51 = /^[\n]/,
        ...
        peg$c53 = function(comment) {
                ...
                return new Node.CommentNode(temp);
             },
        peg$c54 = function(comment) {
                var temp = '';
        ...
        peg$c83 = "simp",
        peg$c84 = { type: "literal", value: "simp", description: "\"simp\"" },
        peg$c85 = "//",
        peg$c86 = { type: "literal", value: "//", description: "\"//\"" },
        peg$c87 = { type: "other", description: "optional whitespace" },
        peg$c88 = /^[ \t\n\r]/,
        ...
        if (s1 !== peg$FAILED) {
          ...
          if (s2 !== peg$FAILED) {
            ...
            if (s3 !== peg$FAILED) {
              s4 = peg$parse_();
              if (s4 !== peg$FAILED) {
                s5 = peg$parsesymbol_DefinitionListSeparator();
                if (s5 !== peg$FAILED) {
                  s6 = peg$parse_();
                  if (s6 !== peg$FAILED) {
                    s7 = peg$parseModel();
              ...
              if (s3 !== peg$FAILED) {
                ...
                if (s4 !== peg$FAILED) {
                  ...
                  if (s5 !== peg$FAILED) {
                    s6 = peg$parse_();
                    if (s6 !== peg$FAILED) {
                      s7 = peg$parseProcess_Hide();
                      if (s7 !== peg$FAILED) {
                        s8 = peg$parse_();
                        if (s8 !== peg$FAILED) {
                          s9 = peg$parsesymbol_DefinitionListEnd();
                          if (s9 !== peg$FAILED) {
                            s10 = peg$parse_();
                            if (s10 !== peg$FAILED) {
                              peg$savedPos = s0;
    ...
    function peg$parseReferenceModel() {
      var s0, s1, s2, s3;

      s0 = peg$currPos;
      s1 = peg$parseReferenceDefinition();
      if (s1 !== peg$FAILED) {
        s2 = peg$parse_();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseRelabelling_AND_Hiding();
          if (s3 !== peg$FAILED) {
            peg$savedPos = s0;
            s1 = peg$c7(s1, s3);
            s0 = s1;
          ...
          if (s2 !== peg$FAILED) {
            ...
            if (s3 !== peg$FAILED) {
              ...
              if (s4 !== peg$FAILED) {
                ...
                if (s5 !== peg$FAILED) {
                  s6 = peg$parseProcess_Name();
                  if (s6 !== peg$FAILED) {
                    s7 = peg$parse_();
                    if (s7 !== peg$FAILED) {
                      s8 = peg$parsesymbol_BracketRight();
                      if (s8 !== peg$FAILED) {
                        peg$savedPos = s0;
                        s1 = peg$c23(s6);
                        s0 = s1;
