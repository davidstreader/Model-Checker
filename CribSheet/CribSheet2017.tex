...
Indexed, specifications can be turned into finite state Petri Nets, FSPN just as they are turned into finite state automata


\[{\sf Petri(\mathcal{A}\parallel \mathcal{B} ) \sim_n  (Petri(\mathcal{A}))\parallel_n Petri(\mathcal{B}))   }\]

\[{\sf      Petri(abs(\mathcal{A}))\sim_n  abs_n(Petri(\mathcal{A})) }\]
