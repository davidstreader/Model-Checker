...
(function (document) {
    ...
    window.addEventListener('WebComponentsReady', function () {
        ...
        app.socket.onopen = function () {
            app.connected = true;
            if (app.liveCompiling) app.compile();
        ...
        app.finalizeBuild = function (results) {
            ...
            _.each(skipped, skip => {
                if (skip.type != "user") app.$.console.log("Skipped adding " + skip.id + " to the render list, as it has too many " + skip.type + " (" + skip.length + " > " + skip.maxLength + ")");
            });
        };
        /**
        ...
        app.downloadFile = function () {
            ...
            let output = "";
            if (app.saveSettings.saveCode) output += app.$.editor.getCode();
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../css-loader/index.js!../less-loader/dist/index.js!./bootstrap-styles.loader.js!./bootstrap.config.js", function() {
			var newContent = require("!!../css-loader/index.js!../less-loader/dist/index.js!./bootstrap-styles.loader.js!./bootstrap.config.js");
...
module.exports = __webpack_require__.p + "glyphicons-halflings-regular.svg?a0180954d7d374e153899d0974b25225";
